                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-blue-200">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="font-semibold text-gray-900 text-sm sm:text-base">StatStick Alumni Reunion</div>
                                </div>
                                <div class="sm:col-span-2">
                                    <div class="text-xs sm:text-sm text-gray-600 mb-1">Account Number</div>
                                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2">
                                        <span class="font-mono font-semibold text-gray-900 text-sm sm:text-base break-all" id="bankAccount">0419101239646</span>
                                        <button type="button"
